...
// @Transactional(readOnly = true)
//    public List<String> averageBra(LocalDate dateFrom, LocalDate dateTo) {
//
//       return registerRepository.averageBra(dateFrom, dateTo);
//
//    }
//     @Transactional(readOnly = true)
//    public List<String> averageEsp(LocalDate dateFrom, LocalDate dateTo) {
//
//      return registerRepository.averageEsp(dateFrom, dateTo);
//
//    }
